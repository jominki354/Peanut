...
def main():
    ...
    model_name = "unsloth/gemma-3-4b-it"  # UNSLOTH 버전의 Gemma 3 4B 모델
    ...
    def tokenize_function(examples):
        return tokenizer(
            ...
            padding="max_length",
            truncation=True,
            max_length=512,  # 컨텍스트 크기 축소 (메모리 절약)
            return_tensors="pt"
        )
...
result = pipe(prompt, max_length=1024, do_sample=True, temperature=0.7)
...
""")
        ...
        print("3. 컨텍스트 크기를 더 줄이기 (256 또는 128)")
        print("4. LoRA 랭크(r)를 더 작게 설정 (2)")
        print("5. 그래디언트 체크포인팅 활성화")
